...
#define close_cover() servo_pwm_set(CLOSE_PWM,COVER_CHANNEL)
#define open_cover() servo_pwm_set(OPEN_PWM,COVER_CHANNEL)
...
void chassis_task(void const *pvParameters)
{
    ...
    //判断底盘电机是否都在线
	motor = get_yaw_gimbal_motor_measure_point();
...
////////////servo ctrl
	if (switch_is_down(chassis_move_transit->chassis_RC->rc.s[1]))
    {
		open_cover(); 
    }
	else
